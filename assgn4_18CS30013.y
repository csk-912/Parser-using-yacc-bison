...
%token BREAK CASE CHAR CONST CONTINUE DEFAULT DO DOUBLE ELSE EXTERN FLOAT FOR GOTO IF INT INLINE LONG RETURN RESTRICT SHORT SIZEOF STATIC STRUCT SWITCH TYPEDEF UNION VOID VOLATILE WHILE 
